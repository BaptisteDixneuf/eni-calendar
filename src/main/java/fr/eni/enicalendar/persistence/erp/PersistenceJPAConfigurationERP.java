...
@Configuration
@ComponentScan(basePackages = { "fr.eni.enicalendar.persistence.erp" })
@PropertySource(value = { "classpath:eni-erp.properties" })
public class PersistenceJPAConfigurationERP {

	@Autowired
	private Environment environment;

	private static final Logger LOGGER = LoggerFactory.getLogger(PersistenceJPAConfigurationERP.class);

	@Bean
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		LocalContainerEntityManagerFactoryBean em = new LocalContainerEntityManagerFactoryBean();
		em.setDataSource(dataSource());
		em.setPackagesToScan("fr.eni.enicalendar.persistence.erp.entities");
		...
		try {
			...
			if (null != environment.getProperty("form.datasource.jndi")) {
				...
				if (null != environment.getProperty("form.datasource.access.to.underlying.connection.allowed")) {
					dataSourceBasic.setAccessToUnderlyingConnectionAllowed(Boolean.valueOf(
							environment.getProperty("form.datasource.access.to.underlying.connection.allowed")));
				}
				if (null != environment.getProperty("form.datasource.default.auto.commit")) {
					dataSourceBasic.setDefaultAutoCommit(
							Boolean.valueOf(environment.getProperty("form.datasource.default.auto.commit")));
				}
				...
				if (null != environment.getProperty("form.datasource.default.transaction.isolation")) {
					dataSourceBasic.setDefaultTransactionIsolation(
							Integer.valueOf(environment.getProperty("form.datasource.default.transaction.isolation")));
				}
				if (null != environment.getProperty("form.datasource.initial.size")) {
					dataSourceBasic
							.setInitialSize(Integer.valueOf(environment.getProperty("form.datasource.initial.size")));
				}
				if (null != environment.getProperty("form.datasource.log.abandoned")) {
					dataSourceBasic
							.setLogAbandoned(Boolean.valueOf(environment.getProperty("form.datasource.log.abandoned")));
				}
				if (null != environment.getProperty("form.datasource.login.timeout")) {
					dataSourceBasic
							.setLoginTimeout(Integer.valueOf(environment.getProperty("form.datasource.login.timeout")));
				}
				...
				if (null != environment.getProperty("form.datasource.max.open.prepared.statements")) {
					dataSourceBasic.setMaxOpenPreparedStatements(
							Integer.valueOf(environment.getProperty("form.datasource.max.open.prepared.statements")));
				}
				if (null != environment.getProperty("form.datasource.max.wait")) {
					dataSourceBasic
							.setMaxWaitMillis(Integer.valueOf(environment.getProperty("form.datasource.max.wait")));
				}
				if (null != environment.getProperty("form.datasource.min.evictable.idle.time.millis")) {
					dataSourceBasic.setMinEvictableIdleTimeMillis(
							Integer.valueOf(environment.getProperty("form.datasource.min.evictable.idle.time.millis")));
				}
				...
				if (null != environment.getProperty("form.datasource.num.tests.per.eviction.run")) {
					dataSourceBasic.setNumTestsPerEvictionRun(
							Integer.valueOf(environment.getProperty("form.datasource.num.tests.per.eviction.run")));
				}
				if (null != environment.getProperty("form.datasource.pool.prepared.statements")) {
					dataSourceBasic.setPoolPreparedStatements(
							Boolean.valueOf(environment.getProperty("form.datasource.pool.prepared.statements")));
				}
				if (null != environment.getProperty("form.datasource.remove.abandoned")) {
					dataSourceBasic.setRemoveAbandonedOnBorrow(
							Boolean.valueOf(environment.getProperty("form.datasource.remove.abandoned")));
				}
				if (null != environment.getProperty("form.datasource.remove.abandoned.timeout")) {
					dataSourceBasic.setRemoveAbandonedTimeout(
							Integer.valueOf(environment.getProperty("form.datasource.remove.abandoned.timeout")));
				}
				if (null != environment.getProperty("form.datasource.test.on.borrow")) {
					dataSourceBasic.setTestOnBorrow(
							Boolean.valueOf(environment.getProperty("form.datasource.test.on.borrow")));
				}
				if (null != environment.getProperty("form.datasource.test.on.return")) {
					dataSourceBasic.setTestOnReturn(
							Boolean.valueOf(environment.getProperty("form.datasource.test.on.return")));
				}
				if (null != environment.getProperty("form.datasource.test.while.idle")) {
					dataSourceBasic.setTestWhileIdle(
							Boolean.valueOf(environment.getProperty("form.datasource.test.while.idle")));
				}
				if (null != environment.getProperty("form.datasource.time.between.eviction.runs.millis")) {
					dataSourceBasic.setTimeBetweenEvictionRunsMillis(Integer
							.valueOf(environment.getProperty("form.datasource.time.between.eviction.runs.millis")));
				}
				...
				if (null != environment.getProperty("form.datasource.validation.query.timeout")) {
					dataSourceBasic.setValidationQueryTimeout(
							Integer.valueOf(environment.getProperty("form.datasource.validation.query.timeout")));
				}
	...
	Properties additionalProperties() {
		...
		if (null != environment.getProperty("form.datasource.hibernate.connection.release_mode")) {
			properties.setProperty("hibernate.connection.release_mode",
					environment.getProperty("form.datasource.hibernate.connection.release_mode"));
		}

		if (null != environment.getProperty("form.datasource.hibernate.namingStrategy")) {
			properties.setProperty("namingStrategy",
					environment.getProperty("form.datasource.hibernate.namingStrategy"));
		}
